...
wget -q https://gitlab.com/JFronny/smalipatcher/-/raw/dev/android/dev/setup2.sh?inline=false -O $PREFIX/var/lib/proot-distro/installed-rootfs/ubuntu-20.04/root/setup2.sh
